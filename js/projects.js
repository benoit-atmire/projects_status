...
function getBadges(t, detailed){
    ...
    t.getAll()
        .then( function (plugindata){
            ...
            var projectdata = plugindata.card.shared.project || {}; // Shared data that replicates and stores the content from the API
            var sladata = plugindata.card.shared.sla || {}; // Shared data that contains the SLA details
